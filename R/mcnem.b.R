...
#         Smc <- -(osp[1]*log(osp[1]/Exos) + osp[2]*log(osp[2]/Exos)) #this for null=1
          ...
          table$setRow(rowNo=1, values=list(Interval="Support for Odds", Level=lintlev, Odds = odds, 
                                            Lower=begL, Upper=endL))
          table$setRow(rowNo=2, values=list(Interval="Likelihood-based* for Odds", Level=conflev, Odds = odds, 
                                            Lower=beg, Upper=end))
          table$setRow(rowNo=3, values=list(Interval="Likelihood-based* for Logodds", Level=conflev, Odds = lodds, 
